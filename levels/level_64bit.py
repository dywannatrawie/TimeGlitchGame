...
from loader import load_fruit_images, load_mouse_images, load_obstacle_image, load_font, load_background
...
class Level4Bit:
    def __init__(self, manager):
        ...
        self.background = load_background("4bit")  
        self.font = load_font("4bit")             
